...
const mocha = CustomColorScheme(
  themeName: AppThemes.mocha,
...
const latte = CustomColorScheme(
  themeName: AppThemes.latte,
...
const frappe = CustomColorScheme(
  themeName: AppThemes.frappe,
  rosewater: Color(0xFFE5C9C3),
  flamingo: Color(0xFFE2B7B7),
  pink: Color(0xFFE5A3D3),
  mauve: Color(0xFFB17DEA),
  red: Color(0xFFE16A8A),
  maroon: Color(0xFFD97A8A),
  peach: Color(0xFFEFAF6A),
  yellow: Color(0xFFE5C08A),
  green: Color(0xFFA6D189),
  teal: Color(0xFF81C8BE),
  sky: Color(0xFF99D1DB),
  sapphire: Color(0xFF85C1DC),
  blue: Color(0xFF8CAAEE),
  lavender: Color(0xFFBABBEE),
...
const macchiato = CustomColorScheme(
  themeName: AppThemes.macchiato,
